  ...
  return (
    ...
    <footer className="overflow-hidden w-full">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 w-full">
        {/* <!-- footer menu start --> */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15 w-full">
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-5 xl:py-7.5 bg-gray-1 w-full">
