    ...
    <div className="group">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span
            onClick={() => handleAddToCart()}
            className="cursor-pointer flex items-center justify-center w-9 h-9 bg-[#F6F7FB] rounded-full"
          >
            <svg
              className="fill-current"
              width="16"
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M2.09069 2.09091C1.72117 2.46042 1.72117 3.09318 2.09069 3.46269L11.6283 13.0003C12.0378 13.4098 12.9622 13.4098 13.3717 13.0003C13.7412 12.6308 13.7412 11.998 13.3717 11.6285L3.8341 2.09091C3.42456 1.68137 2.5002 1.68137 2.09069 2.09091ZM3.0625 8.5C3.0625 8.22461 3.22461 8.0625 3.5 8.0625H12.5C12.7754 8.0625 13.0625 8.22461 13.0625 8.5C13.0625 8.77539 12.7754 9.0625 12.5 9.0625H3.5C3.22461 9.0625 3.0625 8.77539 3.0625 8.5Z"
              />
            </svg>
          </span>
        </div>
