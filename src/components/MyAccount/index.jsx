...
const MyAccount = () => {
  ...
  useEffect(() => {
    ...
    setUserDetails({ id: userId, name: userName, email: userEmail });
    setLoading(false);
  }, []);
              ...
              <div className="flex xl:flex-col">
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                  ...
                  <input
                    ...
                    style={{ display: 'none' }}
                    id="profileImageInput" // Use this ID to trigger the file input on click
                  />
            ...
            >
              <form>
                <p className="text-custom-sm mt-5 mb-9">
                  This will send you a link on your mail to change your acount password
                </p>
                ...
                <div className="bg-white shadow-1 rounded-xl p-4 sm:p-8.5">
                  ...
                  <div
                    ...
                    className="inline-flex cursor-pointer font-medium text-white bg-blue py-3 px-7 rounded-md ease-out duration-200 hover:bg-blue-dark"
                  >
                    Change Password
                  </div>
                </div>
