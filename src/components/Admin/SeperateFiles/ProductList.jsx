...
import AdminProductItem from "../../Common/AdminProductItems";
                    ...
                    <div className="flex gap-4 flex-wrap">
                        ...
                        >
                         ...
                         <select
                            ...
                            className="px-4 py-2 border border-gray rounded-md text-gray hover:bg-gray hover:text-blue focus:outline-none focus:ring-2 focus:ring-blue"
                        >
