...
const SingleGridItem = ({ item }) => {
  const { id, createdAt, image, product_category, product_name, product_description, product_price } = item;
  console.log("id : ", id, "createdAt : ", createdAt, "image : ", "product_category : ", product_category, "product_name : ", product_name, "product_description : ", product_description, "product_price : ", product_price);
  ...
  const handleQuickViewUpdate = () => {
    dispatch(updateQuickView({ id, title, price, discountedPrice, reviews, imgs }));
  };
  ...
  const handleAddToCart = () => {
    dispatch(
      addItemToCart({
        id, title, price, discountedPrice, reviews, imgs,
        product_description,
        status: "available",
        quantity: 1,
      })
