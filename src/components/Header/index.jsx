...
import { auth } from '../../lib/firebaseConfig'; // Import the pre-initialized auth instance
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-1 !border-l border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                    />
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="hidden xl:flex items-center gap-3.5">
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="text-blue hover:text-blue-dark transition duration-300 ease-in-out"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5 cursor-pointer">
              ...
              >
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    <span
                      className={`block relative top-0 left-0 bg-blue rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-[0] ${!navigationOpen && "!w-full delay-300"
                        }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-blue rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${!navigationOpen && "!w-full delay-400"
                        }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-blue rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-200 ${!navigationOpen && "!w-full delay-500"
                        }`}
                    ></span>
                  </span>
                  ...
                  <span className="block absolute right-0 w-full h-full rotate-45">
                    <span
                      className={`block bg-blue rounded-sm ease-in-out duration-200 delay-300 absolute left-2.5 top-0 w-0.5 h-full ${!navigationOpen && "!h-0 delay-[0] "
                        }`}
                    ></span>
                    <span
                      className={`block bg-blue rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-2.5 w-full h-0.5 ${!navigationOpen && "!h-0 dealy-200"
                        }`}
                    ></span>
                  </span>
                </span>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            ...
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row  xl:gap-6">
